<nav class="navbar">
  <div class="container">
      <div class="navbar-brand">
        <a class="navbar-item" href="{{route('home')}}">
          <img src="{{asset('images/white-logo.png')}}" alt="bybu.cc">
        </a>
  ...
  <v-toolbar flat color="transparent" class="main-navbar">
    <v-toolbar-title>
      <a href="{{route('home')}}">
    ...
    <v-toolbar-items class="navbar-links">
      @if (Auth::guest())

        <a href="{{route('jsonbond.index')}}" class="navbar-item showcase-btn">
          <span><i class="fa fa-database"></i> JasonBond</span>
        </a>
        <a href="{{route('me.index')}}" class="navbar-item showcase-btn">
          <span><i class="fa fa-columns"></i> Showcase</span>
        </a>
        <!-- <a class="navbar-item login-btn" href="{{url('/login')}}">
            <span><i class="fa fa-sign-in"></i> Login</span>
